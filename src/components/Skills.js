...
const Skills =({name, x, y}) => {
  return (
    ...
    ">
      ...
      <Skill name="C/C++" x="-24vw" y="-17vw" />

      <Skill name="Node.js" x="-15vw" y="-12vw" />

      <Skill name="React" x="15vw" y="-5vw" />
      ...
      <Skill name="Bootstrap" x="-35vw" y="3vw" />

      <Skill name="Strapi CMS" x="25vw" y="-5vw" />

      <Skill name="Material UI" x="35vw" y="3vw" />
